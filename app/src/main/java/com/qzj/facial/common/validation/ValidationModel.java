 ...
 *
 */
package com.qzj.facial.common.validation;
...
public class ValidationModel {
	...
	public ValidationModel(String modelName,EditText editText, TextView hintView,ValidationExecutor validationExecutor) {
		this(modelName,editText,null,null,hintView,validationExecutor);
	}

	public ValidationModel(String modelName,EditText editText, String relateModelName,EditText relateEditText, TextView hintView, ValidationExecutor validationExecutor) {
