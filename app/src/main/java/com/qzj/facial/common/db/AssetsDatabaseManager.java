...
public class AssetsDatabaseManager {
    ...
    // 外部数据库文件名称
    public static final String DATABASE_NAME = "streetlight.db";
    ...
    private AssetsDatabaseManager(Context context) {
        ...
        this.databasepath = context.getDir("databases", Context.MODE_PRIVATE).getPath();
    }
    ...
    public void createDatabase() {
        ...
        if (!flag || !file.exists()) {
            ...
            dbs.edit().putBoolean(DATABASE_NAME, true).apply();
        } else {
